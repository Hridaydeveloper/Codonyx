...
/**
 * Ranks matches so the closest option appears first:
 * exact > starts-with > word-start > contains.
 */
...
export function SearchableSelect({
  ...
  // Manual ranked filtering + capped rendering keeps huge lists (e.g. cities)
  // opening instantly instead of rendering thousands of nodes.
